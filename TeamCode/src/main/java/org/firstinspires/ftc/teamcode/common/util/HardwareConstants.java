...
public class HardwareConstants {
    ...
    public static final String WHEEL_SERVO_MOTOR = "Servo_Port_0_CH";
    public static final String BALL_PUSHER_MOTOR_LEFT = "SERVO_Port_1_CH";
    public static final String BALL_PUSHER_MOTOR_RIGHT = "SERVO_Port_2_CH";
